 ...
 * - This is NOT an engine template (remains at project level)
 ...
 * 
 * DATA FLOW:
 * Data comes from src/data/content.ts → featureHighlight
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="text-blue-800">
            Ez az oldal projekt-szinten létezik (src/pages/),
